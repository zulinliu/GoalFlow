...
- Use available multi-agent tools for parallel research/review. If subagent tools are deferred, discover them first when the environment supports tool discovery.
...
4. Continue without asking the user.
